...
def load_players(season):
    ...
    if season == "2024-2025":
        ...
        location = "FPL-Elo-Insights/data/2025-2026/players.csv"
...
def load_FPL_info(season, start_gw, end_gw):
    ...
    if season == "2024-2025":
        ...
        location = "FPL-Elo-Insights/data/2025-2026/playerstats.csv"
...
def load_teams_info(season):
    ...
    if season == "2024-2025":
        ...
        location = "FPL-Elo-Insights/data/2025-2026/teams.csv"
